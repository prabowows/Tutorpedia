...
public class AdapterIps extends RecyclerView.Adapter<AdapterIps.ViewHolder> {
    private ArrayList<MapelModel> list;
    private Context context;

    public AdapterIps(ArrayList<MapelModel> list, Context context) {
        this.list = list;
        this.context = context;
    }

    @Override
    public AdapterIps.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(AdapterIps.ViewHolder holder, int position) {
