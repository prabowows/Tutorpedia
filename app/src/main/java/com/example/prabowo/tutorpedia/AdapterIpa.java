...
public class AdapterIpa extends RecyclerView.Adapter<AdapterIpa.ViewHolder> {
    private ArrayList<MapelModel> list;
    private Context context;

    public AdapterIpa(ArrayList<MapelModel> list, Context context) {
        this.list = list;
        this.context = context;
    }

    @Override
    public AdapterIpa.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(AdapterIpa.ViewHolder holder, int position) {
